  ...
  return (
    <section className='contain flex flex-col lg:flex-row items-center gap-3 mt-2 sm:mt-5 lg:mt-10'>
        <div className="w-full lg:w-[60%] lg:pl-14 relative">
          <h2 className="sm:text-xl text-secondary font-light tracking-wider sm:text-center lg:text-left">REAL ESTATE</h2>
          ...
          <SwiperCarousel />
          <div className="absolute top-[47%] sm:top-1/3 -z-10 right-10 sm:right-10 lg:right-5 w-10 sm:w-[3.8rem] aspect-square bg-gradient-to-t from-white to-primary rounded-full rotate-45 opacity-70" />
        </div>
