...
export default function Services() {
  return (
    <section id="services" className='py-16 md:py-24 bg-[#d4d4d4] bg-opacity-30 text-center'>
                    ...
                    services.map((service, i)=>{
                        ...
                        return (
                            <motion.article 
                                ...
                                key={id} 
                                className='bg-white rounded-[1.25rem] lg:rounded-[1.875rem] flex flex-col items-center justify-center py-14 mb-4 md:mb-0'>
