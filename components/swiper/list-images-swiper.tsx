        ...
        <motion.div
            ...
            className="flex h-full items-center">
            {
                        heroCarouselHomeImages.map((url)=>(
                            <div className='group relative overflow-y-hidden cursor-grab h-[30vh] lg:h-[80vh] scale-[98%] w-full shrink-0 transition after:absolute after:bottom-0 after:left-0 after:h-full after:w-full after:bg-gradient-to-t after:from-[rgba(0,0,0,.3)] after:to-transparent' key={url}>
                                <Image 
